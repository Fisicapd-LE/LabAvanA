...
Partendo da questi grafici si possono studiare diverse caratteristiche del fotodiodo, per esempio 
...
(infatti uno studio più accurato verrà fatto per questi e i successivi diodi nelle sezioni successive), perciò a questa misura non si associa incertezza statistica.
